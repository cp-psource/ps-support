			...
			<div class="form-wrap">
				...
				<form id="categories-table-form" action="" method="post">
					...
					<div class="form-field">
						...
						<p><?php _e('Der Name wird verwendet, um die Kategorie zu identifizieren, auf die sich Tickets beziehen', PSOURCE_SUPPORT_LANG_DOMAIN ); ?></p>
					</div>
					<div class="form-field">
						<label for="admin_user"><?php _e( 'Dem Benutzer zuweisen', PSOURCE_SUPPORT_LANG_DOMAIN ); ?></label>
						<?php echo $super_admins_dropdown; ?>
						<p><?php _e( 'Jedes neu eröffnete Ticket mit dieser Kategorie wird diesem Benutzer zugewiesen', PSOURCE_SUPPORT_LANG_DOMAIN ); ?></p>
					</div>
					<?php submit_button( __( 'neue Kategorie hinzufügen', PSOURCE_SUPPORT_LANG_DOMAIN ), 'primary', 'submit-new-ticket-category' ); ?>
				</form>
			</div>
		</div>
	</div>
