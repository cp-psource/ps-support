...
<form method="post" action="">
	<table class="form-table">
		...
		<?php $this->render_row( __( 'Aktiviere Front-End', INCSUB_SUPPORT_LANG_DOMAIN ), ob_get_clean() ); ?>
	</table>
	...
	<div id="front-options" class="<?php echo $front_active ? '' : 'disabled'; ?>">
		<table class="form-table">
			...
			<?php $this->render_row( __( 'Verwende Support-Systemstile', INCSUB_SUPPORT_LANG_DOMAIN ), ob_get_clean() ); ?>
			...
			<?php if ( $pages_dropdowns ): ?>
				<?php $this->render_row( __( 'Support Seite', INCSUB_SUPPORT_LANG_DOMAIN ), $support_pages_dropdown ); ?>
				<?php $this->render_row( __( 'Ticket-Editor Seite', INCSUB_SUPPORT_LANG_DOMAIN ), $submit_ticket_pages_dropdown ); ?>
				<?php $this->render_row( __( 'FAQs Seite', INCSUB_SUPPORT_LANG_DOMAIN ), $faqs_pages_dropdown ); ?>
			<?php endif; ?>
		</table>
