...
<form id="categories-table-form" action="" method="post">
	<table class="form-table">
		...
		<?php $this->render_row( __( 'Kategoriename', PSOURCE_SUPPORT_LANG_DOMAIN ), ob_get_clean() ); ?>
		<?php $this->render_row( __( 'Dem Benutzer zuweisen', PSOURCE_SUPPORT_LANG_DOMAIN ), $super_admins_dropdown ); ?>
	</table>
