...
class Incsub_Support_Network_FAQ_Categories extends Incsub_Support_Admin_Menu {
	...
	public function add_menu() {
		parent::add_submenu_page(
			'ticket-manager',
			__( 'FAQ-Kategorien', INCSUB_SUPPORT_LANG_DOMAIN ),
			__( 'FAQ-Kategorien', INCSUB_SUPPORT_LANG_DOMAIN ), 
	...
	public function set_edit_category_page_title( $title ) {
		...
		return '<h2>' . sprintf( _x( 'Bearbeite %s', 'Bearbeite den Titel des FAQ-Kategorie-Menüs', INCSUB_SUPPORT_LANG_DOMAIN ), $faq_category->cat_name ) . '</h2>';
	}
