...
class Incsub_Support_Tickets_Index_Shortcode extends Incsub_Support_Shortcode {
	...
	public function process_form() {
		...
		if ( isset( $_POST['support-system-submit-reply'] ) && incsub_support_current_user_can( 'insert_reply' ) ) {
			...
			if ( empty( $message ) )
				wp_die( __( 'Die Antwortnachricht darf nicht leer sein', INCSUB_SUPPORT_LANG_DOMAIN ) );
			...
			if ( ! $result )
				wp_die( __( 'Bei der Bearbeitung des Formulars ist ein Fehler aufgetreten. Bitte versuche es später erneut', INCSUB_SUPPORT_LANG_DOMAIN ) );
