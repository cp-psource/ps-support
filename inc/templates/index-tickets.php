				...
				<ul class="support-system-ticket row <?php echo esc_attr( incsub_support_get_the_ticket_class() ); ?>" id="support-ticket-<?php echo incsub_support_get_the_ticket_id(); ?>">
					...
					<li class="small-10 large-11 columns support-system-ticket-content">
						...
						<ul class="inline-list support-system-ticket-meta">
							<li class="support-system-byauthor"><span><?php echo sprintf( __( 'von <strong>%s</strong>', INCSUB_SUPPORT_LANG_DOMAIN ), incsub_support_get_the_author() ); ?></span></li>
							<li class="support-system-lastreply">
								<span><?php echo sprintf( __( 'Letzte Antwort: <a href="%s">%s vor</a>', INCSUB_SUPPORT_LANG_DOMAIN ), esc_url( incsub_support_get_the_last_ticket_reply_url() ), incsub_support_get_the_ticket_updated_date() ); ?></span>
							</li>
